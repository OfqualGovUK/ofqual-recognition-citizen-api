    ...
    public class StageServiceTests
    {
        ...
        public async Task UpsertStageStatusRecord_ReturnsFalse_WhenNoStageTasks()
        {
            ...
            var stageStatus = new StageStatus
            {
                ...
                StageId = StageEnum.PreEngagement,
            ...
            _mockStageRepository.Setup(r => r.GetAllStageTasksByStageId(StageEnum.PreEngagement))
            ...
            _mockStageRepository.Setup(r => r.GetStageStatus(applicationId, StageEnum.PreEngagement))
                .ReturnsAsync(stageStatus);

            // Act
            var result = await _stageService.EvaluateAndUpsertStageStatus(Guid.NewGuid(), StageEnum.PreEngagement);
        ...
        public async Task ReturnsFalse_WhenApplicationIdIsEmpty()
        {
            ...
            // Act
            var result = await _stageService.EvaluateAndUpsertStageStatus(applicationId, StageEnum.PreEngagement);
            // Assert
            Assert.False(result);
            _mockStageRepository.Verify(r => r.UpsertStageStatusRecord(It.IsAny<StageStatus>()), Times.Never);
        }
        ...
        public async Task EvaluateAndUpsertStageStatus_ReturnsFalse_WhenNoQuestions()
        {
            ...
            _mockStageRepository
                .Setup(r => r.GetAllStageTasksByStageId(It.IsAny<StageEnum>()))
        ...
        public async Task DoesNotUpsertStatus_WhenStatusIsUnchanged()
        {
            ...
            {
                new StageTaskView { TaskId = taskId1, StageId = StageEnum.PreEngagement, OrderNumber = 1 },
                new StageTaskView { TaskId = taskId2, StageId = StageEnum.PreEngagement, OrderNumber = 2 }
            };
            ...
            _mockStageRepository.Setup(r => r.GetStageStatus(applicationId, It.IsAny<StageEnum>()))
                .ReturnsAsync(stageStatus);
